...
export function TagSection({ teamId, boardId, cardId }: Props) {
  ...
  const assignedTags = allTags.filter((t) => t.isAssigned);
            ...
            <YStack>
              {filteredTags.map((t) => (
                <XStack
                  ...
                  py="$2.5"
                  gap="$2"
                  onPress={() => handleToggle(t.tagId, t.isAssigned)}
                ...
                >
                  <Text
                    flex={1}
                    fontSize={13}
                    fontWeight={t.isAssigned ? "600" : "500"}
                    style={{ color: t.color }}
                  >
                    #{t.title}
                  </Text>
